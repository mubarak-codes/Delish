...
const Navbar = ({bg, text, setBg, setText})=>{
 ...
 return(
  <>
   <section>
    <nav className={`navbar navbar-expand ${bg} ${text} bb2 b-red fixed-top px3 py3 py4-sm transit`}>
     ...
     <div className={`fixed-top my15 my15-sm my17-md my18-lg shadow-sm d-grid ${bg} ${drop} border border-2 border-secondary border-opacity-10 w50 w25-md w30-sm rounded-3 py4 px1 ms-auto me-2 fs2 gap-2 transit`} ref={dropRef}>
      ...
      <div className="fs4 p2 d-flex justify-content-center gap-3 gap-lg-4 mt2 border-top pt5">
